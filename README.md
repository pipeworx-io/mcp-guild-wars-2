...
```bash
curl -X POST https://gateway.pipeworx.io/v1/tools/worlds \
  -H 'Content-Type: application/json' \
  -d '{"ids":"1013,1019,1022"}'
```

No account needed for the first calls. Inspect any tool: `GET https://gateway.pipeworx.io/v1/tools/worlds`. Find one: `POST https://gateway.pipeworx.io/v1/tools/search_packs` with `{"query":"..."}`.
